...
public class TestNamespacePhilosophies {
    ...
    public void testHedonisticPhilosophy() throws Exception {
        ...
        NamespacedProjection projection = new XBProjector(config, Flags.ABSENT_IS_EMPTY).io().fromURLAnnotation(NamespacedProjection.class);
        ...
        assertEquals("", projection.findElementContentWithPrefixOmittingNS());
        assertEquals("", projection.findElementWithDefaultNamespaceOmittingNS());
